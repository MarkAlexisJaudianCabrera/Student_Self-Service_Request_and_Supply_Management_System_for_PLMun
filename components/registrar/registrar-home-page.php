...
<body>
    ...
    <div class="registrar-pending-container">
        ...
        <p>This page displays all items, categorized by "Academic Items". Accept or Reject requests.</p>
        <hr class="border-top">
                ...
                <tbody>
                    <?php if (count($requests) > 0): ?>
                        ...
                        <tr class="HOVER">
                            ...
                            <td>
                                <div class="inline">
                                    <form method="POST" action="actions/registrar-req-action.php">
                                    ...
                                    <a class="btn-default-style rej" href="actions/registrar-req-action.php?delete=<?= $row['request_id'] ?>">Reject</a>
                                </div>
                            </td>
                            <td>
