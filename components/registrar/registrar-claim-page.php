...
<html>
<head>
    <title>Registrar Dashboard - Student Self-Service Request and Supply Management System for PLMUN</title>
    <link rel="stylesheet" href="/assets/styles/registrar-claim.css">
...
<body>
    ...
    <div class="registrar-pending-container">
        <h2 id="reg-h2-style">Paid Requests - Registrar</h2>
        <p>This page displays all Paid Requests to be claimed, categorized by "Academic Items".</p>
        <hr class="border-top">
        ...
        <form method="GET" class="search-form" id="searchForm">
            <input 
                ...
                name="search" 
                id="searchInput"
                placeholder="Search OR, Student No, Name, or Item..."
            ...
            <?php if (!empty($search)): ?>
                <a href="registrar-claim.php" class="reset-btn">Clear Search</a>
            <?php endif; ?>
        </form>
        ...
        <div class="registrar-pending-table">
                ...
                <tbody>
                    <?php if (count($requests) > 0): ?>
                        ...
                        <tr class="HOVER">
                            ...
                            <td>
                                <div class="inline">
                                    <form method="POST" action="actions/registrar-claim-action.php">
