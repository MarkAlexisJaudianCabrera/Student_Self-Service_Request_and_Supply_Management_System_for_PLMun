<?php
    ...
    if (isset($_POST['update'])) {
        ...
        switch ($status){
            ...
            case 'Unpaid':
                $note = 'THIS REQUEST WAS ACCEPTED BY BUSINESS CENTER, YOU MAY NOW PROCEED FOR THE PAYMENT AT UNIVERSITY TREASURY OFFICE OR CASHIER';
                break;
        }
    ...
    if (isset($_GET['delete'])) {
        ...
        sendNotificationEmail($or_number, $email, $status, 'UNFORTUNATELY THIS REQUEST WAS REJECTED BY BUSINESS CENTER, CONTACT THE BUSINESS CENTER OR REQUEST AGAIN', $status." BY BUSINESS CENTER"); 
    }
