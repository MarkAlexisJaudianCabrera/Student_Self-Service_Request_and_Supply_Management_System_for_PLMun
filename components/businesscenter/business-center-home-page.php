...
<html>
<head>
    <title>Business Center Dashboard - Student Self-Service Request and Supply Management System for PLMUN</title>
    <link rel="stylesheet" href="/assets/styles/businesscenter.css">
...
<body>
    ...
    <div class="business-center-pending-container">
        <h2 id="reg-h2-style">Pending Requests - Business Center</h2>
        <p>This page displays all items, categorized by "Supply Items". Accept or Reject requests.</p>
        <hr class="border-top">
        <div class="business-center-pending-table">
            <table border="1" width="100%">
                <tr>
                    ...
                    <th>Status</th>
                    <th>Items</th>
                    <th>Total (Includes Other Category)</th>
                    <th>Update Status</th>
                </tr>
                ...
                <tr class="HOVER">
                    ...
                    <td>
                        <div class="inline">
                           <form method="POST" action="actions/business-center-req-action.php">
                            ...
                            <a class="btn-default-style rej" href="actions/business-center-req-action.php?delete=<?= $row['request_id'] ?>">Reject</a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
