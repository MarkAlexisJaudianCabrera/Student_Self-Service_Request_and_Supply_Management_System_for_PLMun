...
<head>
    ...
    <link rel="stylesheet" href="/assets/styles/businesscenter-claim.css">
...
<body>
    ...
    <div class="business-center-pending-container">
        <h2 id="reg-h2-style">Paid Requests - Business Center</h2>
        <p>This page displays all Paid Requests to be claimed, categorized by "Supply Items".</p>
        <hr class="border-top">
                ...
                <tbody>
                    <?php if (count($requests) > 0): ?>
                        ...
                        <tr class="HOVER">
                            ...
                            <td>
                                <div class="inline">
                                    <form method="POST" action="actions/business-center-claim-action.php">
